...
const Jobs = ({ job }) => {
	...
	return (
		<div className="border-2 border-[#e8e8e8] m-4 p-8 rounded-xl">
			...
			<NavLink
				to={`/jobs/${id}`}
				className="px-2 py-3 ] max-sm:w-2/6 max-sm: text-xs font-bold xl:text-xl md:w-[45%] lg:w-[55%] xl:w-[30%]   md:text-xl text-white rounded-md bg-gradient-to-r from-[#818eff] from-10% via-[#8a82ff] via-35% to-[#9576ff] to-85%"
			>
				View Details
			</NavLink>
		</div>
