...
const Header = () => {
  const links = (
    <>
      <div className="max-sm:flex max-sm:text-lg max-sm:flex-col  text-[#757575] text-2xl font-extrabold md:flex-col md:space-x-24  max-sm:text-white max-sm:gap-4  ">
        <NavLink
          to={"/"}
    ...
    <div className=" navbar md:p-2 bg  xl:w-[85%]  mx-auto ">
      <div className="  w-full flex justify-between md:p-2 ">
        ...
        <div className="navbar-end grid ">
          <NavLink to="/job" className=" max-sm:text-base max-sm:p-2 max-md:text-2xl max-md:p-4 md:text-2xl p-4 rounded-xl text-white bg-gradient-to-r from-[#818eff] from-10% via-[#8a82ff] via-30% to-[#9576ff] to-85%">
            Apply Now
          </NavLink>
        </div>
      </div>
